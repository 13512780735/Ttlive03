package com.likeits.ttlive.activitys.custom;
 ...
 */
public class CommandPhotoUtil01 {
     ...
     */
    public CommandPhotoUtil01(Context mContext, CustomScrollGridView gridView, GridAdapter01 gridAdapter, PhotoSystemOrShoot selectPhoto) {
