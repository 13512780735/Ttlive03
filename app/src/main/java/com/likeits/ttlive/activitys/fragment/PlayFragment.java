...
import com.likeits.ttlive.activitys.ui.home.PlayActivity;
 ...
 */
public class PlayFragment extends DialogFragment implements View.OnClickListener  {
    private ImageView ivClose;
    private MyListview mListview;
    private List<Map<String, Object>> dataList;
    // 图片封装为一个数组
    private String[] name = {"线上陪玩", "线下陪玩"};
