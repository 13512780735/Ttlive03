...
public class MakeFriendsActivity extends FragmentActivity {
    ...
    ViewPager viewpager;
    private MakeFriendsActivity mContext;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View main = getLayoutInflater().from(this).inflate(R.layout.activity_make_friends, null);
    ...
    private void initView() {
        ...
        mDatas = new ArrayList<String>(Arrays.asList("全部","热门","相亲","男女模","速配","音乐"));
